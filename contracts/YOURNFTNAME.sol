...
contract YOURNFTNAME is ERC721, Ownable, ERC721Enumerable, ContextMixin, NativeMetaTransaction {
    ...
    constructor () ERC721("YOURNFTNAME", "ShortNftName") {
        _initializeEIP712("YOURNFTNAME");
    }
